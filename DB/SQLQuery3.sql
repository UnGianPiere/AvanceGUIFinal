...
('BON001', 'Bonificación 1', 500.00),
('BON002', 'Bonificación 2', 300.00),
('BON003', 'Bonificación 3', 250.00),
('BON004', 'Bonificación 4', 400.00),
('BON005', 'Bonificación 5', 600.00);
...
(1, 'Juan Pérez', 3000.00, 'Gerente'),
(2, 'María López', 2500.00, 'Asistente'),
(3, 'Carlos Gómez', 3500.00, 'Analista'),
(4, 'Ana Rodríguez', 2800.00, 'Asistente'),
(5, 'Luis Martínez', 4000.00, 'Gerente');
...
-- Crear el usuario asociado al inicio de sesión en la base de datos "Sueldos"
